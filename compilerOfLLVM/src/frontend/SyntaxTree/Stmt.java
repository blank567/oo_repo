...
public class Stmt {
    ...
    public boolean isReturnHaveExp() {
        return exps.size() > 0 && exps.get(0).getType() != -1;
    }
...
//            if(adder.value.equals("%2") && data.value.equals("%90")) {
//                System.out.println(adder.valueType);
//                System.out.println(data.valueType);
//            }
